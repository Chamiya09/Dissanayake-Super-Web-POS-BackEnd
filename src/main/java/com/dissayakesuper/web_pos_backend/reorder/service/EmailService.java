 ...
 * <ol>
 *   <li><b>Supplier PO</b> — an invoice-style HTML email sent to the supplier with
 *       full line-item detail, totals, and the authorising manager’s name.</li>
 *   <li><b>Admin Notification</b> — a concise dashboard-alert email sent to the
...
public class EmailService {
    ...
    // ── Admin notification HTML builder ──────────────────────────────────────
                        ...
                        <tr>
                          <td style="padding:0 32px 28px;">
                            ...
                            <p style="margin:2px 0 0;font-size:11px;color:#94a3b8;">
                              Purchasing Department &mdash; Dissanayake Super
                            </p>
                          </td>
                        </tr>
