...
public class EmailService {
  ...
  private static final String TYPE_SUPPLIER_PO = "SUPPLIER_PO";
  private static final String TYPE_ADMIN_ALERT = "ADMIN_ALERT";
  private static final String TYPE_SUPPLIER_CONFIRMATION = "SUPPLIER_CONFIRMATION";
    ...
    public void sendSupplierPO(
      ...
      String html = EmailUiTemplate.wrapInCommonLayout(
        ...
        sendHtmlOrThrow(to, subject, html, "supplier PO", orderRef, TYPE_SUPPLIER_PO);
    }
    ...
    sendHtmlBestEffort(adminEmail, subject, html, "admin notification", orderRef, TYPE_ADMIN_ALERT);
    }
    ...
    public void sendSupplierConfirmationDoneMail(
      ...
      String subject = "Purchase Order Confirmed - " + orderRef;
        ...
        sendHtmlBestEffort(adminEmail, subject, html, "supplier confirmation", orderRef, TYPE_SUPPLIER_CONFIRMATION);
    }
    ...
    private void sendHtmlOrThrow(String to, String subject, String html,
             String kind, String orderRef, String mailType) {
        try {
        ...
        message.setHeader(WEB_POS_MAIL_TYPE_HEADER, mailType);
    ...
    private void sendHtmlBestEffort(String to, String subject, String html,
                    String kind, String orderRef, String mailType) {
      try {
        sendHtmlOrThrow(to, subject, html, kind, orderRef, mailType);
